...
if __name__ == '__main__':
    ...
    plt.plot(times_foam, rtd_foam, label='OpenFOAM')
    plt.plot(times_ccm, rtd_ccm, label='OpenCCM')
    ...
    plt.plot(times_foam, cm_foam, label='OpenFOAM')
    plt.plot(times_ccm, cm_ccm, label='OpenCCM')
